...
export default function MobileAppLayout({ children }: MobileAppLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <header className="bg-gradient-to-br from-pink-600 via-pink-500 to-rose-400 text-white px-4 pt-6 pb-24 rounded-b-[32px]">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-3">
            ...
            <Link href="/my-dashboard" className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
              </svg>
            </Link>
      ...
      {/* Bottom Navigation - Solid White Background */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-lg border-t border-gray-200 px-4 py-3 shadow-2xl z-50">
