      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white pt-24 pb-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Memuat layanan kami...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white pt-24 pb-12">
        <div className="container mx-auto px-4">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            <p className="text-red-600 font-semibold">Error: {error || 'Layanan tidak ditemukan'}</p>
      ...
      <div className="container mx-auto px-4">
        ...
        {currentTreatments.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-600 text-lg">Tidak ada layanan di kategori ini</p>
          </div>
        )}
        ...
        <div className="mt-16 bg-white rounded-lg shadow-md p-8 border border-pink-100">
          ...
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              <span className="text-pink-600 font-bold mt-1">✓</span>
              <span>Hasil yang terlihat dan memuaskan</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-pink-600 font-bold mt-1">✓</span>
