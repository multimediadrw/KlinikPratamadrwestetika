    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Kode Tidak Valid</h1>
          <p className="text-gray-600 mb-8">
            {error || 'Kode affiliate tidak ditemukan atau belum diaktifkan. Silakan hubungi admin.'}
          </p>
          <Link
            href="/"
    ...
    <main className="min-h-screen bg-gradient-to-br from-pink-50 to-white">
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-8">
        ...
        <div className="bg-gradient-to-br from-pink-100 to-pink-50 border-2 border-pink-300 rounded-xl p-8 mb-8 shadow-lg">
          ...
          {affiliateData.assignedEmail && (
            <div className="mb-4">
              <div className="text-sm text-gray-600 mb-1">Email Terdaftar:</div>
              <div className="text-lg font-semibold text-gray-800">{affiliateData.assignedEmail}</div>
            </div>
          )}
          
          <div className="bg-white border-2 border-pink-200 rounded-lg p-4 mb-4">
            <div className="text-xs text-gray-600 mb-2">💡 Bagikan link ini untuk mendapatkan komisi dari setiap reservasi</div>
          ...
          <div className="text-xs text-gray-500 italic">
            💾 Simpan link halaman ini untuk akses dashboard kapan saja
          </div>
        </div>
